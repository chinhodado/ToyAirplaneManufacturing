...
public class Conveyors 
{
	...
	private ArrayList<Component> conveyor = new ArrayList<Component>();  // Size is initialised to 0
	...
	protected int getN() { return(conveyor.size()); }
	protected void spInsertQue(Component comp) { conveyor.add(comp); }
