...
public class InputDataModelling {
    // observation interval: weeks x days/week x hours/day x minutes/hour
    public final static int OBSERVATION_INTERVAL = 10 * 7 * 24 * 60;
    ...
    public static void arrivalRun(RandomSeedGenerator rsg) {
        ...
        // Generate data for part A components over 5 weeks (5*7*26*60) = 50,400
        // minutes
        ...
        while (aArrival < OBSERVATION_INTERVAL && bArrival < OBSERVATION_INTERVAL) {
            if (aArrival <= bArrival) // should be rare that arrivals are equal
            {
                if (aArrival == bArrival)
                    System.out.printf(" aArrival = bArrival at %f\n", aArrival); // Flag
                                                                                 // equality
                // save aArrival as next arrival and get next value for aArrival
                arrivals.add(aArrival); // Example of autoboxing - double value
                                        // in aArrival is automatically
            ...
            } else // bArrival < aArrival
            {
                ...
                arrivals.add(bArrival); // Example of autoboxing - double value
                                        // in aArrival is automatically
                                        // converted to a Double object
